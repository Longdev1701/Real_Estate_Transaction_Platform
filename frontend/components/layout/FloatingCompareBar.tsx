...
export function FloatingCompareBar() {
  ...
  if (pathname?.startsWith("/admin") || pathname?.startsWith("/messages") || pathname === "/compare") {
    return null;
  }
  ...
  return (
    <div className="fixed bottom-20 left-1/2 z-[999] w-[90%] max-w-md -translate-x-1/2 animate-in fade-in slide-in-from-bottom-5 duration-300 md:bottom-6">
